...
import com.example.nafis.nf.organizetestcenter.Adapter.ChapterAdapter
import com.example.nafis.nf.organizetestcenter.Model.ChapterModel
import com.example.nafis.nf.organizetestcenter.databinding.FragmentChapterBinding
...
class ChapterFragment (private val subject: String?, private val clas:String?) : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.backarrowbtn.setOnClickListener{
            activity?.supportFragmentManager?.beginTransaction()?.replace(R.id.wrapper,SubFragment(clas))?.commit()
